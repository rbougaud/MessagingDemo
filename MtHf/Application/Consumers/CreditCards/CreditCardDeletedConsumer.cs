...
public class CreditCardDeletedConsumer(ILogger logger, IMediator mediator, ICustomerRepositoryReader customerRepositoryReader) : IConsumer<CreditCardDeleted>
{
