...
public class ReaderContext : DbContext
{
    ...
    public ReaderContext(DbContextOptions<ReaderContext> options, IPublishEndpoint publishEndpoint) : base(options)
    {
    ...
    {
        optionsBuilder.AddInterceptors(new AuditReaderInterceptor(_publishEndpoint));
